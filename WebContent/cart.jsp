...
<body>
  ...
  <div class="container-fluid">
	...
	<div class="container my-3">
		<div class="d-flex py-3"><h3>Tổng tiền: ${(total>0)?(total):0}đ </h3> <a class="mx-3 btn btn-primary" href="cart-check-out">Thanh toán</a></div>
		<table class="table table-light">
			...
			<tbody>
				...
				<tr>
					...
					<td><a href="remove-from-cart?id=<%=c.getId() %>" class="btn btn-sm btn-danger">Xóa khỏi giỏ hàng</a></td>
				</tr>
